...
from qstrader.signals.signals_collection import SignalsCollection # used to wrap(包装) the various signals
from qstrader.data.backtest_data_handler import BacktestDataHandler # 链接股票池以及data sources
...
class TopNMomentumAlphaModel(AlphaModel):
    ...
    def __call__(
        ...
        # momentum lookback period, 相当于是要有足够的信息才能生成信号.
...
if __name__ == "__main__":
    ...
    start_dt = pd.Timestamp('1998-12-22 01:30:00', tz=pytz.UTC)
    burn_in_dt = pd.Timestamp('1999-12-22 01:30:00', tz=pytz.UTC)
