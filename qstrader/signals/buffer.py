...
class AssetPriceBuffers(object):
    ...
    def add_asset(self, asset):
        """
        Add an asset to the list of current assets. This is necessary if # MARK: 新加入的资产还会不会有 burn_in_dt
    ...
    def append(self, asset, price):
        ...
        for lookback in self.lookbacks:
            self.prices[
                AssetPriceBuffers._asset_lookback_key( # 这是一个deque, 当达到最大长度时, 如果继续添加元素, 则会删除第一个元素
                    asset, lookback)].append(price)
